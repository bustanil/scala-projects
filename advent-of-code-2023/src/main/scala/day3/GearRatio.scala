...
object GearRatio {
  ...
  def main(args: Array[String]): Unit = {
    val content = Source
      .fromFile(
        "/Users/bustanil.arifin/workspace/personal/scala-projects/advent-of-code-2023/src/main/scala/day3/input.txt"
      )
      .mkString
  ...
  def adjacentNumbers(r: Int, c: Int)(
      numberMap: NumberMap
  ): List[(Int, Int, Int)] =
    numberMap
      ...
      .flatMap(numbers =>
        numbers.filter { // filter numbers who are adjacent to c
          case (value, start, _end) if (c >= start - 1 && c <= _end + 1) => true
          case _ => false
        }
      )
      .toList
